# Simple HTTP Flask on Python

This directory contains a simple HTTP server written for the [Flask](https://flask.palletsprojects.com/) framework in [Python](https://www.python.org/) running with Unikraft in binary compatibility mode.
